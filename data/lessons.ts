...
export const lessons: Lesson[] = [
  {
    ...
    quickChecks: [
      {
        prompt: "¿Qué tipo de contaminación afecta los ríos o lagos?",
        choices: ["air pollution", "water pollution", "soil pollution"],
        correctAnswer: "water pollution",
        explanation: "Es la contaminación que afecta el agua.",
      },
      {
        prompt: "¿Qué tipo de contaminación afecta el suelo?",
        choices: ["soil pollution", "air pollution", "water pollution"],
        correctAnswer: "soil pollution",
        explanation: "Es la contaminación que afecta la tierra o el suelo.",
      },
      {
        prompt: "¿Qué tipo de contaminación afecta el aire que respiramos?",
        choices: ["water pollution", "soil pollution", "air pollution"],
        correctAnswer: "air pollution",
        explanation: "Es la contaminación que afecta el aire.",
      },
    ],
  ...
  },
  {
    ...
    quickChecks: [
      ...
      },
      {
        ...
        explanation: "Esta acción significa usar menos recursos.",
      },
    ],
  ...
  },
  {
    ...
    evaluablePhrases: ["matter", "property", "properties", "color", "temperature", "weight", "texture", "taste", "hot", "cold", "heavy", "smooth", "rough", "soft", "hard", "sweet", "salty", "sour", "bitter"],
    audioText:
    ...
    quickChecks: [
      {
        prompt: "¿Qué propiedad indica si algo está caliente o frío?",
        choices: ["temperature", "color", "taste"],
        correctAnswer: "temperature",
        explanation: "Esta propiedad indica qué tan caliente o frío está algo.",
      },
      {
        prompt: "¿Qué propiedad indica qué tan pesado es algo?",
        choices: ["texture", "weight", "color"],
        correctAnswer: "weight",
        explanation: "Esta propiedad indica qué tan pesado es un objeto.",
      },
      {
        prompt: "¿Qué propiedad puede describirse como lisa o áspera?",
        choices: ["taste", "temperature", "texture"],
        correctAnswer: "texture",
        explanation: "Esta propiedad describe cómo se siente una superficie.",
      },
    ],
  ...
  },
  {
    ...
    quickChecks: [
      {
        prompt: "¿Cuáles son los tres estados de la materia?",
        choices: ["solid, liquid and gas", "reduce, reuse and recycle", "color, texture and taste"],
        correctAnswer: "solid, liquid and gas",
        explanation: "Son las tres formas principales en las que encontramos la materia.",
      },
      {
        prompt: "¿Qué cambio ocurre cuando el hielo se convierte en agua?",
        choices: ["freeze", "melt", "condense"],
        correctAnswer: "melt",
        explanation: "El hielo se derrite y se convierte en agua líquida.",
      },
      {
        prompt: "¿Cómo se llama el agua cuando está en forma de gas?",
        choices: ["steam", "soil", "waste"],
        correctAnswer: "steam",
        explanation: "Es el nombre del agua en estado gaseoso.",
      },
    ],
  ...
  },
  {
    ...
    quickChecks: [
      {
        prompt: "Escoge la oración correcta.",
        choices: ["He watches TV.", "He watch TV.", "He watchs TV."],
        correctAnswer: "He watches TV.",
        explanation: "Con él, ella o eso, los verbos terminados en ch agregan es.",
      },
      {
        prompt: "Completa la oración: She ___ have a bike.",
        choices: ["don't", "doesn't", "does"],
        correctAnswer: "doesn't",
        explanation: "Con ella usamos la forma negativa correspondiente a la tercera persona.",
      },
      {
        prompt: "Completa la pregunta: ___ you have toast for breakfast?",
        choices: ["Do", "Does", "Has"],
        correctAnswer: "Do",
        explanation: "Las preguntas dirigidas a tú comienzan con este auxiliar.",
      },
    ],
  ...
  },
  {
    ...
    quickChecks: [
      {
        prompt: "Responde: Is Tom good at surfing?",
        choices: ["Yes, he is.", "Yes, she is.", "Yes, they are."],
        correctAnswer: "Yes, he is.",
        explanation: "Tom es un niño, por eso la respuesta usa el pronombre masculino.",
      },
      {
        prompt: "Completa la oración: He ___ his teeth after breakfast.",
        choices: ["brushes", "walks", "plays"],
        correctAnswer: "brushes",
        explanation: "La acción indicada es cepillarse los dientes.",
      },
      {
        prompt: "Completa la oración: After school, he ___ with his friends.",
        choices: ["gets", "plays", "brushes"],
        correctAnswer: "plays",
        explanation: "La oración indica que él juega con sus amigos.",
      },
    ],
  ...
  },
  {
    ...
    quickChecks: [
      {
        prompt: "Completa la oración: My birthday is ___ March.",
        choices: ["in", "on", "at"],
        correctAnswer: "in",
        explanation: "Esta preposición se usa con los meses.",
      },
      {
        prompt: "Completa la oración: There's a party ___ 8 o'clock.",
        choices: ["on", "at", "in"],
        correctAnswer: "at",
        explanation: "Esta preposición se usa con horas específicas.",
      },
      {
        prompt: "Completa la palabra: My favorite t___ is my new train.",
        choices: ["oy", "oi", "aw"],
        correctAnswer: "oy",
        explanation: "Estas letras completan la palabra que significa juguete.",
      },
    ],
  ...
  },
  {
    ...
    quickChecks: [
      {
        prompt: "Completa la oración comparative: A is ___ than B.",
        choices: ["bigger", "biggest", "the big"],
        correctAnswer: "bigger",
        explanation: "Para comparar dos objetos usamos la forma comparativa antes de than.",
      },
      {
        prompt: "Completa la oración superlative: A is ___ fastest.",
        choices: ["than", "the", "more"],
        correctAnswer: "the",
        explanation: "La forma superlativa se construye con este artículo.",
      },
      {
        prompt: "¿Cuál opción es un superlative?",
        choices: ["longer than", "the longest", "long"],
        correctAnswer: "the longest",
        explanation: "Esta opción significa el más largo y es una forma superlativa.",
      },
    ],
